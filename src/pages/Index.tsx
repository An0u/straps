...
const Index: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-background relative overflow-hidden">
      ...
      <header className="absolute top-4 left-4 md:left-4 left-1/2 md:translate-x-0 -translate-x-1/2 z-30 pointer-events-none">
        <div className="bg-card/80 backdrop-blur-sm rounded-lg px-4 py-3 flex flex-col md:items-start items-center md:text-left text-center">
